                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" id="s2">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="offset-sm-2 col-sm-10">
                                            <div class="form-check">
                                                ...
                                                {!! Form::checkbox('ADD_DKIM', 1, SettingsHelper::getInstance()->getValueForKey('ADD_DKIM') == 1 ? true : false, ['class' => 'form-check-input']) !!}

                                                {!! Form::label('ADD_DKIM', trans('frontend.form.add_dkim'), ['class' => 'form-check-label']) !!}
                                    ...
                                    <div class="form-group row">
                                        ...
                                        {!! Form::label('DKIM_DOMAIN', trans('frontend.form.dkim_domain'), ['class' => 'col-sm-2 col-form-label']) !!}

                                        <div class="col-sm-10">

                                            {!! Form::text('DKIM_DOMAIN', SettingsHelper::getInstance()->getValueForKey('DKIM_DOMAIN'), ['placeholder' => trans('frontend.form.dkim_domain'), 'class' => 'form-control']) !!}
                                    ...
                                    <div class="form-group row">
                                        ...
                                        {!! Form::label('DKIM_SELECTOR', trans('frontend.form.dkim_selector'), ['class' => 'col-sm-2 col-form-label']) !!}

                                        <div class="col-sm-10">

                                            {!! Form::text('DKIM_SELECTOR', SettingsHelper::getInstance()->getValueForKey('DKIM_SELECTOR'), ['placeholder' => trans('frontend.form.dkim_selector'), 'class' => 'form-control']) !!}
                                    ...
                                    <div class="form-group row">
                                        ...
                                        {!! Form::label('DKIM_PRIVATE', trans('frontend.form.dkim_private'), ['class' => 'col-sm-2 col-form-label']) !!}

                                        <div class="col-sm-10">

                                            {!! Form::textarea('DKIM_PRIVATE', SettingsHelper::getInstance()->getValueForKey('DKIM_PRIVATE'), ['rows' => "4", 'placeholder' => trans("frontend.form.dkim_private"), 'class' => 'form-control']) !!}

                                            @if ($errors->has('DKIM_PRIVATE'))
                                                <span class="text-danger">{{ $errors->first('DKIM_PRIVATE') }}</span>
                                            @endif
                                    ...
                                    <div class="form-group row">
                                        ...
                                        {!! Form::label('DKIM_PASSPHRASE', trans('frontend.form.dkim_passphras'), ['class' => 'col-sm-2 col-form-label']) !!}

                                        <div class="col-sm-10">

                                            {!! Form::text('DKIM_PASSPHRASE', SettingsHelper::getInstance()->getValueForKey('DKIM_PASSPHRASE'), ['placeholder' => trans('frontend.form.dkim_passphras'), 'class' => 'form-control']) !!}
                                    ...
                                    <div class="form-group row">
                                        ...
                                        {!! Form::label('DKIM_IDENTITY', trans('frontend.form.dkim_identity'), ['class' => 'col-sm-2 col-form-label']) !!}

                                        <div class="col-sm-10">

                                            {!! Form::text('DKIM_IDENTITY', SettingsHelper::getInstance()->getValueForKey('DKIM_IDENTITY'), ['placeholder' => trans('frontend.form.dkim_identity'), 'class' => 'form-control']) !!}

                                            @if ($errors->has('DKIM_IDENTITY'))
