...
return [
    ...
    'hint' => [
        'template_index' => 'This section displays a list of templates that you can use for mailing lists.',
        'category_index' => 'Subscriber category - these are the sections used to sort subscribers and to which you can link the subject of the newsletter.',
        'subscribers_index' => 'A subscriber is a person who has been added or subscribed to a subscriber category. Your existing subscribers are shown below. ',
        'subscribers_import' => 'You can import subscribers from a text file, as well as from an MS Excel file and Ods. The following Excel formats are supported: xls (Excel 97-2003), xlsx (Excel 2007), Csv and OpenDocument format (ODF). The format of the file cells is shown in the figure below.',
        'log_index' => ' Here you can view statistics for each mailing list. Important! Counting the number of emails read is possible only for outgoing emails in html format, as well as if email clients do not block automatic image downloads.',
        'redirect_index' => 'Here you can view link click-through statistics, the number of user clicks from links in the newsletter. ',
        'smtp_index' => 'Add the SMTP servers through which the mailing will be sent. If you have added more than one SMTP server, the distribution will be carried out randomly through the list of SMTP servers.',
        'cron_job_list' => 'Please note that all cron jobs below must be added to your server for the application to work properly. Please contact your web hosting provider\'s support to understand how these cron jobs should be added to your server.',
        'phpinfo' => '',
        'faq_index' => '',
        'update_index' => '',
        'users_index' => '',
