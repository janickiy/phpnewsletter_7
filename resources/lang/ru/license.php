...
Действие данного лицензионного соглашения распространяется на все
программные продукты или иные разработчик JANICKY.COM, в которых
указано, что данная программа может распространяться только на условиях
...
праве. Настоящее лицензионное соглашение адресовано Вам и заключается с Вами.
Данное лицензионное соглашение распространяется только на изготовление
копий, распространение и модификацию Программного продукта. Иные виды
действий над Программным продуктом выходят за рамки данного лицензионного
соглашения.
...
лицензионному соглашению и отсутствию каких-либо гарантий, и передаете всем
сторонним получателям Программного продукта копию данного лицензионного
соглашения вместе с Программным продуктом.
...
3. Если модифицируемая программа предназначена для интерактивной работы,
...
просмотреть копию данного лицензионного соглашения.
...
9. Если вы хотите включить части Программного продукта в иные свободно
распространяемые программные продукты, но распространяемые на иных условиях,
вы должны письменно спросите позволения у авторов.

ОТКАЗ ОТ ПРЕДОСТАВЛЕНИЯ ГАРАНТИЙ

10. ВВИДУ ТОГО, ЧТО ПРОГРАММНЫЙ ПРОДУКТ ЛИЦЕНЗИРУЕТСЯ БЕСПЛАТНО, НИКАКИЕ
ГАРАНТИИ НЕ ПРЕДОСТАВЛЯЮТСЯ В ТОЙ МЕРЕ, В КАКОЙ ЭТО ПОЗВОЛЯЕТСЯДЕЙСТВУЮЩИМ
...
ПРИЕМЛЕМОСТЬЮ ДЛЯ ВАС КАЧЕСТВА И ПРОИЗВОДИТЕЛЬНОСТИ ПРОГРАММНОГО ПРОДУКТА,
ВЫ ПРИНИМАЕТЕ НА СЕБЯ. В СЛУЧАЕ, ЕСЛИ ПРОГРАММНЫЙ ПРОДУКТ РАБОТАЕТ НЕКОРРЕКТНО,
ВЫ САМИ НЕСЕТЕ ВСЕ НЕОБХОДИМЫЕ РАСХОДЫ ПО ОБСЛУЖИВАНИЮ, УСТРАНЕНИЮ НЕПОЛАДОК
И ИСПРАВЛЕНИЮ.

11. НИ ПРИ КАКИХ ОБСТОЯТЕЛЬСТВАХ, ЗА ИСКЛЮЧЕНИЕМ СЛУЧАЕВ, КОГДА ТОГО ТРЕБУЕТ ЗАКОН,
ИЛИ ПО ПИСЬМЕННОМУ СОГЛАШЕНИЮ, НИКТО ИЗ ОБЛАДАТЕЛЕЙ АВТОРСКИХ ПРАВ ИЛИ ИНЫХ
ЛИЦ, ВНОСЯЩИХ ИЗМЕНЕНИЯ И\ИЛИ ЗАНИМАЮЩИХСЯ ДАЛЬНЕЙШИМ РАСПРОСТРАНЕНИЕМ
ПРОГРАММНОГО ПРОДУКТА НА ПРИВЕДЕННЫХ ВЫШЕ УСЛОВИЯХ, НЕ НЕСЕТ ОТВЕТСТВЕННОСТИ ЗА УБЫТКИ,
ВКЛЮЧАЯ ОБЩИЕ, СПЕЦИФИЧЕСКИЕ, СЛУЧАЙНЫЕ ИЛИ КОСВЕННЫЕ, ЯВЛЯЮЩИЕСЯ СЛЕДСТВИЕМ
ИСПОЛЬЗОВАНИЯ ИЛИ НЕВОЗМОЖНОСТИ ИСПОЛЬЗОВАНИЯ ПРОГРАММНОГО ПРОДУКТА (В ТОМ ЧИСЛЕ ПОТЕРЮ
ДАННЫХ, НЕУДОБНЫЙ ДЛЯ ВАС СПОСОБ ПОЛУЧЕНИЯ ДАННЫХ, ИЛИ ДОПОЛНИТЕЛЬНЫЕ РАСХОДЫ,
ПОНЕСЕННЫЕ ВАМИ ИЛИ ТРЕТЬИМИ ЛИЦАМИ, ИЛИ ОТКАЗ РАБОТАТЬ СОВМЕСТНО С КАКИМИ-
ЛИБО ИНЫМИ ПРОГРАММНЫМИ ПРОДУКТАМИ, ДАЖЕ ЕСЛИ ВЫШЕУПОМЯНУТЫЙ ПРАВООБЛАДАТЕЛЬ
ИЛИ ИНОЕ ЛИЦО БЫЛИ ПРЕДУПРЕЖДЕНЫ О ВОЗМОЖНОСТИ ПОДОБНЫХ УБЫТКОВ.
...
ПРИГОДНОСТИ К КУПЛЕ-ПРОДАЖЕ или ИСПОЛЬЗОВАНИЮ В КОНКРЕТНЫХ ЦЕЛЯХ Вместе с
данной программой вы должны получить нашу лицензию на программный продукт
",
];
