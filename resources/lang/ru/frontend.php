...
return [
    ...
    'hint' => [
        ...
        'cron_job_list'  => 'Обратите внимание, что все задания cron ниже должны быть добавлены на ваш сервер для правильной работы приложения. Пожалуйста, обратитесь в поддержку веб-хостинга провайдера, чтобы понять, как эти задания cron должны быть добавлены на ваш сервер.',
        'phpinfo'   => '',
        'faq_index' => '',
        'update_index' => '',
        'users_index'  => '',
