...
return [
    ...
    'hint' => [
        ...
        'subscribers_import' => 'Вы можете импортировать подписчиков из текстового файла, а также из MS Excel файла и Ods. Поддерживаются следующие форматы Excel: xls (Excel 97-2003), xlsx (Excel 2007), Csv и OpenDocument формат (ODF). Формат ячеек файла приведен на рисунке внизу.',
