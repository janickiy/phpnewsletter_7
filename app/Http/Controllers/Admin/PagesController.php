...
class PagesController extends Controller
{
    ...
    public function phpinfo(): View
    {
        ...
        $infoAlert = __('frontend.hint.phpinfo') ?? null;
    ...
    public function subscriptionForm(): View
    {
        ...
        return view('admin.pages.subscription_form', compact('infoAlert','subform','subformJs'))->with('title', __('frontend.title.subscription_form'));
    }
}
