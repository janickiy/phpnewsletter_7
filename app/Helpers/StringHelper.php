...
class StringHelper
{
    ...
    {
        $str = preg_replace("/^utf\-8$/i", __('frontend.str.charutf8'), $str);
        $str = preg_replace("/^iso\-8859\-1$/i", __('frontend.str.iso88591'), $str);
        $str = preg_replace("/^iso\-8859\-2$/i", __('frontend.str.iso88592'), $str);
        $str = preg_replace("/^iso\-8859\-3$/i", __('frontend.str.iso88593'), $str);
        $str = preg_replace("/^iso\-8859\-4$/i", __('frontend.str.iso88594'), $str);
        $str = preg_replace("/^iso\-8859\-5$/i", __('frontend.str.iso88595'), $str);
        $str = preg_replace("/^koi8\-r$/i", __('frontend.str.koi8r'), $str);
        $str = preg_replace("/^koi8\-u$/i", __('frontend.str.koi8u'), $str);
        $str = preg_replace("/^iso\-8859\-6$/i", __('frontend.str.iso88596'), $str);
        $str = preg_replace("/^iso\-8859\-8$/i", __('frontend.str.iso88598'), $str);
        $str = preg_replace("/^iso\-8859\-7$/i", __('frontend.str.iso88597'), $str);
        $str = preg_replace("/^iso\-8859\-9$/i", __('frontend.str.iso88599'), $str);
        $str = preg_replace("/^iso\-8859\-10$/i", __('frontend.str.iso885910'), $str);
        $str = preg_replace("/^iso\-8859\-13$/i", __('frontend.str.iso885913'), $str);
        $str = preg_replace("/^iso\-8859\-14$/i", __('frontend.str.iso885914'), $str);
        $str = preg_replace("/^iso\-8859\-15$/i", __('frontend.str.iso885915'), $str);
        $str = preg_replace("/^iso\-8859\-16$/i", __('frontend.str.iso885916'), $str);
        $str = preg_replace("/^windows\-1250$/i", __('frontend.str.windows1250'), $str);
        $str = preg_replace("/^windows\-1251$/i", __('frontend.str.windows1251'), $str);
        $str = preg_replace("/^windows\-1252$/i", __('frontend.str.windows1252'), $str);
        $str = preg_replace("/^windows\-1253$/i", __('frontend.str.windows1253'), $str);
        $str = preg_replace("/^windows\-1254$/i", __('frontend.str.windows1254'), $str);
        $str = preg_replace("/^windows\-1255$/i", __('frontend.str.windows1255'), $str);
        $str = preg_replace("/^windows\-1256$/i", __('frontend.str.windows1256'), $str);
        $str = preg_replace("/^windows\-1257$/i", __('frontend.str.windows1257'), $str);
        $str = preg_replace("/^windows\-1258$/i", __('frontend.str.windows1258'), $str);
        $str = preg_replace("/^gb2312$/i", __('frontend.str.gb2312'), $str);
        $str = preg_replace("/^big5$/i", __('frontend.str.big5'), $str);
        $str = preg_replace("/^iso-2022\-jp$/i", __('frontend.str.iso2022jp'), $str);
        $str = preg_replace("/^ks_c_5601\-1987$/i", __('frontend.str.ksc56011987'), $str);
        $str = preg_replace("/^euc\-kr$/i", __('frontend.str.euckr'), $str);
        $str = preg_replace("/^windows\-874$/i", __('frontend.str.windows874'), $str);
